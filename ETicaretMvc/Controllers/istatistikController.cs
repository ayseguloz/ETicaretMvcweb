...
namespace ETicaretMvc.Controllers
{
    public class istatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d9 = deger9;
            var deger10 = c.Uruns.Count(x => x.UrunAd=="Mikser").ToString();
            ViewBag.d10 = deger10;
            ...
            ViewBag.d15 = deger15;
            var deger16 = c.SatisHarekets.Where(x => x.Tarih == bugun).Sum(y => (decimal?)y.ToplamTutar).ToString();  // 0 niye yazmadı
            ViewBag.d16 = deger16;
            return View();
        }
